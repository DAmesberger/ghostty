...
// darwin/x86_64 s2n-bignum assembly objects. Preserve the x86_64 assembly
...
#define CFI_PUSH(reg) pushq   reg
#define CFI_POP(reg) popq    reg

#define CFI_INC_RSP(offset) addq    $offset, %rsp
#define CFI_DEC_RSP(offset) subq    $offset, %rsp
#else
